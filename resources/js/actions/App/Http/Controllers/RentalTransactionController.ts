 ...
 * @see app/Http/Controllers/RentalTransactionController.php:20
 ...
 * @see app/Http/Controllers/RentalTransactionController.php:33
...
const RentalTransactionController = { index, show, returnItems }

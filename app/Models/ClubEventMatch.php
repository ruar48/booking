...
class ClubEventMatch extends Model
{
    ...
    {
        return $this->belongsTo(ClubEventRegistration::class, 'entry1_id');
    }

    public function entry2(): BelongsTo
    {
        return $this->belongsTo(ClubEventRegistration::class, 'entry2_id');
    }

    public function winner(): BelongsTo
    {
        return $this->belongsTo(ClubEventRegistration::class, 'winner_registration_id');
    }
}

...
class OpenPlayRegistrationService
{
     ...
     */
    public function register(ClubEvent $event, Player $player, ?Player $partner, int $createdBy): ?string
    {
     ...
     */
    public function pairRandomly(ClubEvent $event): int
    {
        if ($event->team_size !== TeamSize::Doubles) {
            return 0;
        }
    ...
    private function isRegistered(ClubEvent $event, Player $player): bool
    {
